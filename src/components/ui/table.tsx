...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto">
    <table
      ref={ref}
      className={cn("w-full caption-bottom text-sm border border-collapse", className)}
      {...props}
    />
  </div>
))
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("p-4 text-left align-middle [&:has([role=checkbox])]:pr-0", className)}
    {...props}
  />
))
